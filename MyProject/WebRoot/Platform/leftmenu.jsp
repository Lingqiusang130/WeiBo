    ...
    <div id="sidebar-wrapper">
      ...
      <ul id="main-nav">
        ...
        <li> 
          ...
          <ul>
            <li>
              <a href="send2.jsp" target="_top"><div align="center">群发功能</div></a></li>
          </ul>
        </li>
        <li> 
          <a href="#" class="nav-top-item"> <div align="center">微博接口管理</div> </a>
          <ul>
            <li>
              <a href="insert2.jsp" target="_top"><div align="center">已支持微博平台</div></a></li>
          </ul>
        </li>
        <li> 
          ...
          <ul>
            <li>
              <a href="" target="_top"><div align="center">平台用户统计</div></a></li>
            <li>
              <a href="" target="_top"><div align="center">应用用户统计</div></a></li>
          </ul>
        </li>
        <li> 
